...
int main(int argc, char* argv[])
{
	...
	filename[3] = input_path + var3_filename;
	filename[4] = input_path + var4_filename;
	filename[5] = input_path + var5_filename;
	filename[6] = input_path + var6_filename;
	filename[7] = input_path + var7_filename;
	filename[8] = input_path + var8_filename;
	filename[9] = input_path + var9_filename;
	filename[10] = input_path + var10_filename;
