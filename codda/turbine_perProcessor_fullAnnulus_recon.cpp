...
int main(int argc, char* argv[])
{
	...
	string vts_output_path = "/media/hazarika/WD2/ResearchDataStore2/codda/turbine/turbine_full_annulus_grids/grid_data_output/time"+timeId+"/out_"+procId+"_"+timeId+"_recon.vts";
